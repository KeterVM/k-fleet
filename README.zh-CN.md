...
AI 写代码时，有时会没弄清需求就动手，写完了却没把功能接起来，
或者测试都过了，真正用起来还是不对。

K Fleet 把应对这些问题的做法整理成一套 skills：需求不清楚时先问清楚，
改动复杂时先想好怎么做，写完后检查功能是否真的能用。
同类错误反复出现时，还要看看做事的方法哪里需要改。

目的是让你少重复交代这些要求，也让 AI 知道什么时候才算把事情做完。
简单修改可以直接做，需要哪种方法就用哪种，不必每次走完整套流程。
